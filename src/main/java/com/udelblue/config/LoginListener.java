...
import com.udelblue.controllers.UserController;
        ...
        public void onApplicationEvent(ApplicationEvent appEvent) {
            ...
            if (appEvent instanceof AuthenticationSuccessEvent) {
                ...
                if (!r.getuRI().contains("/account/user")) {
                    ...
                    UserDetails userDetails = (UserDetails) authenticationSuccessEvent
                    ...
                    userrepository.loginAuditAccount(username, userloginTime, eventtype,
                            r.getiPAddress(), r.getOperatingSystem(), r.getBrowserName(),
            ...
            if (appEvent instanceof AuthenticationFailureBadCredentialsEvent) {
                UserController.isSuccessLogin = false;
            }
