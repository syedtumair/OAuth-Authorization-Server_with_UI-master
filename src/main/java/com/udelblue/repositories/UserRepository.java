...
public class UserRepository {
    ...
    public String activeAccountFromEmail(String email, String token) {
        String SQL = "UPDATE users  SET [enabled] = '1' , auth_token = :token WHERE email = :email;";
        // UPDATE Supplier
        ...
        String returntype = "";
        try {
            returntype = namedParameterJdbcTemplate.queryForObject(SQL, namedParameters,
                    String.class);
        } catch (Exception e) {
    ...
    public String createAccount(String email, String username, String password, String firstname,
            String lastname, String userType) {

        String SQL = "INSERT INTO users ([username],[password] ,[email] ,[firstname],[lastname],[createdon],[enabled], [user_type]) VALUES( :username , :password, :email , :firstname , :lastname, :createdon , :enabled, :user_type);";
        int returntype = 0;
        try {
            ...
            namedParameters.put("user_type", userType);
    ...
    public String getLatestLoginAuditUsername(String eventtype) {

        String SQL = "SELECT TOP (1) username FROM user_audit_log WHERE eventtype = :eventtype order by eventtime desc";
        // SqlParameterSource namedParameters = new MapSqlParameterSource("id",
        // id);
        SqlParameterSource namedParameters = new MapSqlParameterSource("eventtype", eventtype);
    ...
    public Map<String, Object> getUserDetailsByUsername(String username) {
        ...
        Map<String, Object> mapOfRecords = new HashMap();
        try {
            mapOfRecords = namedParameterJdbcTemplate.queryForMap(SQL, namedParameters);
    ...
    public String loginAuditAccount(String username, String eventtime, String eventtype,
            String ipaddress, String operatingsystem, String browser, String uri,
            String fingerprint) {
